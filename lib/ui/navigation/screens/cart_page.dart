                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              _showDeleteConfirmationDialog(context, cartItem.productId);
                            },
                            child: Container(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            formatCurrency(cartItem.productPrice.toDouble()),
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: const Icon(Icons.remove, size: 14, color: AppColors.bluePrimary),
                            ),
                          ),
                          Text(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: const Icon(Icons.add, size: 14, color: AppColors.bluePrimary),
                            ),
                          ),
                        ],
                      ),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: AppButton(
                ...
                color: totalAmount == 0.0 ? AppColors.grey : AppColors.bluePrimary,
